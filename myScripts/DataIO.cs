...
public class DataIO : MonoBehaviour
{
    ...
    void ReceiveCallback(IAsyncResult ar)
    {
        ...
        try
        {
            SensorData data = JsonUtility.FromJson<SensorData>(dataFromESP32);
            sensorValue32 = data.sensorValue32;
            sensorValue33 = data.sensorValue33;
            sensorValue34 = data.sensorValue34;
            sensorValue35 = data.sensorValue35;
            flashlightButtonState = data.flashlightButtonState;
            rssiValue = data.rssi;
    ...
    void SendPositionData()
    {
        if (targetObject != null)
        {
            ...
            Debug.Log("Position Data sent: " + json);
        }
    }
